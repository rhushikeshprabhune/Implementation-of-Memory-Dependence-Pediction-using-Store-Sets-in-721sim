...
private:
	...
	/////////////////////////////////////////////////////////////////////
    uint64_t logic_regs;
    uint64_t physical_regs;
    uint64_t unres_branch;
    ...
    uint64_t freelist_tail;
    uint64_t freelist_entries;
    ...
    actv_list *active_list;
    uint64_t actvlist_head;
    uint64_t actvlist_tail;
    uint64_t actvlist_entries;
    uint64_t actvlist_size;
    ...
    br_checkpoint *branch_checkpoint;
	...
	/////////////////////////////////////////////////////////////////////
    void init_rmt();
    void bak_rmt(uint64_t branch_id);
    void restore_rmt(uint64_t branch_id);
    void free_rmt();
    void init_amt();
    void restore_amt_rmt();
    void free_amt();
    void init_freelist();
    void bak_freelist_head(uint64_t branch_id);
    uint64_t get_freereg();
    void return_freereg(uint64_t preg_id);
    void restore_freelist(uint64_t branch_id);
    void squash_freelist();
    void free_freelist();
    void init_actvlist();
    void restore_actvlist(uint64_t al_id);
    void squash_actvlist();
    void free_actvlist();
    void init_phy_regfile();
    void free_phy_regfile();
    void init_GBM();
    void bak_gbm(uint64_t branch_id);
    void restore_GBM(uint64_t branch_id);
    uint64_t find_gbmfreebit();
    void set_gbmbit(uint64_t branch_id);
    void clear_gbmbit(uint64_t branch_id);
    uint64_t num_gbmfreebits();
    void init_GBM_bak();
    void free_GBM_bak();
...
public:
	...
	void set_store_pc(uint64_t store_pc, unsigned int AL_index);
	void set_store_inum(unsigned int AL_index, unsigned int store_inum);
};
